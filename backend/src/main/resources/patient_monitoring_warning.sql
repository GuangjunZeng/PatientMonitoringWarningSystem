...
INSERT INTO `monitor` (`monitor_id`, `user_hospital_id`, `monitor_time`, `height`, `weight`, `body_temperature`, `heart_rate`, `blood_pressure_high`, `blood_pressure_low`, `blood_oxygen`, `blood_glucose`, `blood_lipid`) VALUES (2, 3, '2024-10-31 14:00:00', 1.70, 64.00, 37.00, 64, 130, 75, 98.00, 4.20, 3.80);
INSERT INTO `monitor` (`monitor_id`, `user_hospital_id`, `monitor_time`, `height`, `weight`, `body_temperature`, `heart_rate`, `blood_pressure_high`, `blood_pressure_low`, `blood_oxygen`, `blood_glucose`, `blood_lipid`) VALUES (3, 4, '2024-10-31 20:00:00', 1.73, 65.00, 36.80, 66, 124, 72, 95.00, 4.80, 3.20);
INSERT INTO `monitor` (`monitor_id`, `user_hospital_id`, `monitor_time`, `height`, `weight`, `body_temperature`, `heart_rate`, `blood_pressure_high`, `blood_pressure_low`, `blood_oxygen`, `blood_glucose`, `blood_lipid`) VALUES (4, 5, '2024-10-31 21:00:00', 1.75, 67.00, 36.90, 68, 128, 75, 98.00, 4.50, 3.50);
INSERT INTO `monitor` (`monitor_id`, `user_hospital_id`, `monitor_time`, `height`, `weight`, `body_temperature`, `heart_rate`, `blood_pressure_high`, `blood_pressure_low`, `blood_oxygen`, `blood_glucose`, `blood_lipid`) VALUES (5, 6, '2024-10-31 22:00:00', 1.71, 62.00, 36.50, 63, 125, 77, 98.00, 4.90, 3.60);
INSERT INTO `monitor` (`monitor_id`, `user_hospital_id`, `monitor_time`, `height`, `weight`, `body_temperature`, `heart_rate`, `blood_pressure_high`, `blood_pressure_low`, `blood_oxygen`, `blood_glucose`, `blood_lipid`) VALUES (6, 7, '2024-10-30 23:00:00', 1.76, 68.00, 36.60, 69, 122, 71, 99.00, 4.40, 3.90);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` (`user_id`, `user_role`, `user_name`, `user_password`, `user_gender`, `user_dob`, `user_address`, `user_contact`) VALUES (1, 'Admin', 'admin', 'admin1', 'Male', '2000-01-01', 'H Company', '1-12345678');
...
INSERT INTO `user` (`user_id`, `user_role`, `user_name`, `user_password`, `user_gender`, `user_dob`, `user_address`, `user_contact`) VALUES (3, 'Patient', 'bob', 'bob1', 'Male', '2001-01-10', 'A2 Street', '5-55555555');
...
INSERT INTO `user` (`user_id`, `user_role`, `user_name`, `user_password`, `user_gender`, `user_dob`, `user_address`, `user_contact`) VALUES (5, 'Patient', 'dave', 'dave1', 'Male', '2003-09-13', 'A2 Street', '3-54935847');
...
-- ----------------------------
BEGIN;
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (1, 3, 1, '2024-10-24', '2024-10-31');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (2, 4, 3, '2024-10-26', NULL);
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (3, 5, 2, '2024-10-28', '2024-10-31');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (4, 6, 2, '2024-10-28', '2024-10-31');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (5, 7, 7, '2024-10-28', NULL);
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (6, 8, 7, '2024-10-28', '2024-10-31');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (7, 9, 7, '2024-10-29', '2024-10-30');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (8, 10, 8, '2024-10-30', '2024-11-15');
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (9, 11, 3, '2024-10-30', NULL);
INSERT INTO `user_hospital` (`user_hospital_id`, `user_id`, `hospital_id`, `hospitalization_date`, `discharge_date`) VALUES (10, 12, 3, '2024-10-30', '2024-11-16');
COMMIT;
